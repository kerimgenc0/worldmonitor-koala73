  ...
  async function buildRouter() {
    const [
      ...
      mapServerMod, mapHandlerMod,
        ...
        import('./src/generated/server/worldmonitor/map/v1/service_server'),
        import('./server/worldmonitor/map/v1/handler'),
      ]);
    ...
    const allRoutes = [
      ...
      ...mapServerMod.createMapServiceRoutes(mapHandlerMod.mapHandler, serverOptions),
    ];
