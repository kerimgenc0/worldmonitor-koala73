...
const BROWSER_ORIGIN_PATTERNS = [
  ...
  // This project: production + previews (worldmonitor-koala73.vercel.app and *-kerims-projects-*.vercel.app)
  /^https:\/\/worldmonitor-koala73\.vercel\.app$/,
  /^https:\/\/worldmonitor-koala73-[a-z0-9-]+-kerims-projects-[a-z0-9]+\.vercel\.app$/,
