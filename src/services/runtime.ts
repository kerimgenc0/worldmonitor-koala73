...
const _env = (typeof import.meta !== 'undefined' && (import.meta as { env?: Record<string, string | undefined> }).env)
  ? (import.meta as { env: Record<string, string | undefined> }).env
  : {
    VITE_WS_API_URL: process.env.VITE_WS_API_URL ?? '',
    VITE_WS_RELAY_URL: process.env.VITE_WS_RELAY_URL ?? '',
    VITE_DESKTOP_RUNTIME: process.env.VITE_DESKTOP_RUNTIME,
    VITE_TAURI_API_BASE_URL: process.env.VITE_TAURI_API_BASE_URL,
    VITE_TAURI_REMOTE_API_BASE_URL: process.env.VITE_TAURI_REMOTE_API_BASE_URL,
  };
